...
namespace FaultlessExecution.Abstractions
{
    public interface IFaultlessExecutionService
    {
        ...
        FuncExecutionResult<T> TryExecute<T>(Func<T> code, string message = "Error caught by Faultless", params object[] args);
        ...
        Task<AsyncFuncExecutionResult<T>> TryExecuteAsync<T>(Func<Task<T>> code, string message = "Error caught by Faultless", params object[] args);
        ...
        /// <param name="args">An object array that contains zero or more objects to format.</param>
        /// <returns>a <see cref="AsyncFuncExecutionResult"/> which indicates WasSuccessful, the exception that was raised(if one raised), as well as the return value T of your delegate code</returns>
        Task<AsyncFuncExecutionResult<T>> TryExecuteSyncAsAsync<T>(Func<T> code, string message = "Error caught by Faultless", params object[] args);
        ...
        ActionExecutionResult TryExecute(Action code, string message = "Error caught by Faultless", params object[] args);
        ...
        /// <param name="args">An object array that contains zero or more objects to format.</param>
        /// <returns>a ActionExecutionResult which indicates WasSuccessful and the exception that was raised(if one raised)</returns>
        Task<AsyncActionExecutionResult> TryExecuteAsync(Func<Task> code, string message = "Error caught by Faultless", params object[] args);
        ...
        Task<AsyncActionExecutionResult> TryExecuteSyncAsAsync(Action code, string message = "Error caught by Faultless", params object[] args);
